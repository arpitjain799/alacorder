...
def loadgui():
     ...
     fetch_layout = [
           [sg.Text("""Collect case PDFs in bulk from Alacourt.com\nfrom a list of names or search parameters.""",font=HEADER_FONT,pad=(5,5))],
...
columns works too).""", pad=(5,5))],
     ...
     window = sg.Window(title="alacorder", layout=layout, grab_anywhere=True, resizable=True, size=[550,550]) # MacOS: [510, 525]	Windows: [
     progress_total = 100
     virgin = True
     while True:
