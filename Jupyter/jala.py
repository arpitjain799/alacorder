...
alacfetchhead = """<a id="fetch"></a><h1>Retrieve case detail PDFs in bulk from Alacourt.com</h1>
...
arc_title = IPython.display.HTML("""<a id="arc"></a><h1 id="case-text-archive">Case Text Archive</h1>
...
mtab_title = IPython.display.HTML("""<a id="mtab"></a><h1 id="multitable-export">Multitable Export</h1>
...
stab_title = IPython.display.HTML("""<a id="stab"></a><h1 id="single-table-export">Single Table Export</h1>
